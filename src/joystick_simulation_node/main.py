...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        pov_button_4.released.connect(lambda i=4: release_pov(i))
        ...
        pov_button_6.released.connect(lambda i=6: release_pov(i))
        ...
        pov_button_7.released.connect(lambda i=7: release_pov(i))
        extra_pov_button_up.append(pov_button_7)

        pov_button_8 = QPushButton("D")
        pov_button_8.pressed.connect(lambda i=8: press_pov(i))
        extra_pov_button_down.append(pov_button_8)
        pov_button_8.released.connect(lambda i=8: release_pov(i))
        ...
        button_box_layout.addWidget(pov_button_3, 6, 0)
        button_box_layout.addWidget(pov_button_4, 6, 1)
        button_box_layout.addWidget(pov_button_5, 6, 2)
        button_box_layout.addWidget(pov_button_6, 7, 0)
        button_box_layout.addWidget(pov_button_7, 7, 1)
        button_box_layout.addWidget(pov_button_8, 7, 2)
